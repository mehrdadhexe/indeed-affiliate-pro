...
<div class="uap-page-title">همکاری در فروش - <span class="second-text"><?php _e('Help', 'uap');?></span></div>

<div class="uap-stuffbox">
	<h3 class="uap-h3">
		<?php _e('Activate همکاری در فروش', 'uap');?>
	</h3>
			...
			<div class="uap-clear"></div>
				<div class="uap-license-status"><?php 
					if (isset($submited)){
							if ($submited){
							?>
								<div class="uap-dashboard-valid-license-code"><?php _e("You've activated the همکاری در فروش plugin!", 'uap');?></div>
							<?php 
							} else {
							?>
