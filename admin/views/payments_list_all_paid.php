<div class="uap-wrapper">
	<div class="uap-page-title">همکاری در فروش - <span class="second-text"><?php _e('Paid Referrals', 'uap');?></span></div>
		...
		<table class="wp-list-table widefat fixed tags uap-admin-tables">
			...
			<tbody class="ui-sortable uap-alternate">
				...
				<tr>
                   ...
                   <!-- $array['currency']    -->
					<td><?php echo uap_format_price_and_currency("تومان", $array['amount']);?></td>
